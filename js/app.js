/* Dashboard loader — resilient load order + UI polish */
(function(){
  const polish=document.createElement('link');
  polish.rel='stylesheet';
  polish.href='css/polish.css?v=20260830b';
  document.head.appendChild(polish);
  function load(src,onload){
    const s=document.createElement('script');
    let finished=false;
    const done=function(){if(finished)return;finished=true;if(onload)onload();};
    s.src=src;
    s.onload=done;
    s.onerror=function(e){console.error('Gagal memuat',src,e);done();};
              ...
              load('js/tka-category-fix.js?v=20260830b',function(){
                load('js/tka-mapel-student-status.js?v=20260830a',function(){
                  load('js/student-name-alias.js?v=20260830f',function(){
                    load('js/student-master-fix.js?v=20260830a',function(){
                      ...
                      setTimeout(async function(){
                        try{
                          ...
                          if(typeof window.applyStudentMasterFix==='function')window.applyStudentMasterFix();
                            ...
                            load('js/utbk-kpi-detail.js?v=20260828a',function(){
                              load('js/test-name-fix.js?v=20260828a',function(){
                                load('js/student-selector-dedupe.js?v=20260830e',function(){
                                  load('js/overview-count-fix.js?v=20260830a',function(){
                                    try{
